...
const getDetailItem = (idShop, idItem) => {
  const url =
    "https://shopee.vn/api/v2/item/get?itemid=" + idItem + "&shopid=" + idShop;
};

const viewPage = (idShop = "", idItem = "") => {
    const body = [null,null,"\"vsqvTEyW8bxm0gOnDYi5HLCrwYbXvSsaomr4ssIypxjYgt00tP3KrcZ6jAaLE/3yBD69Tj/oQOSoseJbZebV1iRf2wdcAjnm0J5INrNN6Z0\"",null,null,5,3,[[null,2207448661,110268868,null,false,false,null,null,null,null,[],null,null,null,null,null,null,null,null]],1557473530602,"VN","\"UUfADeS8wJalhPljDc2gQg==\"",null,[]];
    return new Promise((res, rej) => {
    request(
      {
        ...
        headers: {
          ...
          "Referer": "https://shopee.vn/product/110268868/2207394496/",
          "User-Agent":
            "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.131 Safari/537.36",
        },
...
const search = async key => {
  const url =
    "https://shopee.vn/api/v2/search_items/?by=relevancy&keyword=" +
    key +
...
var dataString =
  '[null,null,""vsqvTEyW8bxm0gOnDYi5HLCrwYbXvSsaomr4ssIypxjYgt00tP3KrcZ6jAaLE/3yBD69Tj/oQOSoseJbZebV1iRf2wdcAjnm0J5INrNN6Z0"",null,null,5,3,[[null,2207448661,110268868,null,false,false,null,null,null,null,[],null,null,null,null,null,null,null,null]],1557473530602,"VN",""UUfADeS8wJalhPljDc2gQg=="",null,[]]';
